		...
		<div  class="map" id="MapBook" >
           ...
           <input type="hidden" name="shelf"  >
				...
				<table id="table1">
					<tbody>
                            <tr>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==0 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div> @endif @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==1 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div> @endif @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==2 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==3 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==4 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==5 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==6 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark" > @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==7 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark" > @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==8 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==9 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==10 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif  @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==11 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif  @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==12 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif  @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==13 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif  @endforeach  </td>
                              ...
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==40 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==41 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==42 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==43 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==44 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==45 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==46 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==47 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==48 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==49 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                              <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 0 && $bookshelfs->cell ==50 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                  ...
                                  <tr>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==0 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==1 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==2 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==3 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==4 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==5 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==6 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==7 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==8 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==9 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==10 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    ...
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==40 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==41 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==42 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==43 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==44 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==45 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==46 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==47 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==48 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==49 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 1 && $bookshelfs->cell ==50 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>


                                  </tr>
                                  <tr>
                                    <td class="redips-mark" > @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==0 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==1 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==2 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==3 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==4 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==5 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==6 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==7 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==8 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    ...
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==43 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==44 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==45 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==46 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==47 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==48 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==49 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 2 && $bookshelfs->cell ==50 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                  ...
                                  <tr>
                                    ...
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==44 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==45 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==46 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==47 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==48 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==49 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
                                    <td class="redips-mark"> @foreach ($bookshelf as $bookshelfs ) @if($bookshelfs->row == 3 && $bookshelfs->cell ==50 ) <div  class="redips-drag t1" title="infinite cloning"> <input type="text" style="width: 31px"   class="input" value="{{$bookshelfs->id_shelf}}"   readonly> </div>  @endif   @endforeach  </td>
	...
	$.ajax({
        ...
        location.reload();
            ...
            $.each(errors.messages, function(key, value) {
                alert("คุณใส่เลขตู้หนังสือซ้ำเลข"+value);
                });
